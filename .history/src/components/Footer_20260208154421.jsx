  ...
  return (
    <footer className="footer">
          ...
          <div className="footer-grid">
            <div className="footer-brand">
              <Link to="/" className="footer-logo">
                ...
                <span className="logo-name">Manara</span>
              </Link>
              <p className="footer-description">
                Boulangerie & Pâtisserie artisanale depuis 2010. 
                Des produits frais, faits maison avec amour et passion.
                {isRamadan && (
                  <>
                    <br /><br />
            ...
            <div className="footer-links">
              ...
              <ul>
                ...
                <li><Link to="/gateaux/devis">Demander un devis</Link></li>
              </ul>
            </div>
            ...
            <div className="footer-contact">
              ...
              <div className="opening-hours">
                {isRamadan ? (
                  <>
                    <p><strong>Horaires Ramadan :</strong></p>
                    <p>Mar - Sam : 9h00 - 21h00</p>
                    <p>Dimanche : 9h00 - 14h00</p>
                    <p>Lundi : Fermé</p>
                    <p style={{ marginTop: '8px', color: 'var(--color-gold, #D4AF37)', fontSize: '0.8rem' }}>
                      Livraison Iftar disponible
                    </p>
                  </>
                ) : (
                  <>
                    <p><strong>Horaires :</strong></p>
                    <p>Mar - Sam : 7h00 - 19h30</p>
      ...
      <div className="footer-bottom">
        <div className="container">
          <p>&copy; 2024 Manara Boulangerie. Tous droits réservés.</p>
