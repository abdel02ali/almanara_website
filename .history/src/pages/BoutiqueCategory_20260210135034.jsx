    ...
    <div className="category-page">
      <header className="category-header">
        <div className="category-header-bg">
          <OptimizedImage src={categoryInfo.image} alt={categoryInfo.name} priority sizes="100vw" />
          ...
          <div className="related-grid">
            {categories
              ...
              .map(cat => (
                ...
                >
                  <OptimizedImage src={cat.image} alt={cat.name} sizes="(max-width: 640px) 100vw, 25vw" />
