    ...
    <div className="category-page">
      <header className="category-header">
        <div className="category-header-bg">
          <OptimizedImage src={categoryInfo.image} alt={categoryInfo.name} priority fill sizes="100vw" />
            ...
            {products.map(product => (
              <article key={product.slug || product.id} className="product-card card">
                <div className="product-image">
                  <OptimizedImage src={product.image} alt={product.name} sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 25vw" />
                  {product.badge && (
          ...
          <div className="related-grid">
            {categories
              ...
              .map(cat => (
                ...
                >
                  <OptimizedImage src={cat.image} alt={cat.name} fill sizes="(max-width: 640px) 100vw, 25vw" />
