        ...
        <div className="container">
          <div className="recruitment-card">
            <div className="recruitment-content">
              <span className="section-subtitle">{t('contact.recruitmentSubtitle')}</span>
              <h2>{t('contact.recruitmentTitle')}</h2>
              <p>{t('contact.recruitmentDesc')}</p>
