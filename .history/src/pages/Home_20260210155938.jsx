  ...
  return (
    <div className="home">
      ...
      <section className="section occasions-home-section">
        <div className="container">
          <div className="section-header">
            <span className="section-subtitle">{t('home.occasionsSubtitle')}</span>
            <h2>{t('home.occasionsTitle')}</h2>
            <p>{t('home.occasionsDesc')}</p>
          </div>
          <div className="occasions-home-grid">
            <div className="occasions-home-card">
              <img src="https://images.unsplash.com/photo-1519340241574-2cec6aef0c01?w=500&h=350&fit=crop" alt={t('home.occasionsWedding')} loading="lazy" />
              <div className="occasions-home-overlay">
                <h3>{t('home.occasionsWedding')}</h3>
              </div>
            </div>
            <div className="occasions-home-card">
              <img src="https://images.unsplash.com/photo-1464349095431-e9a21285b5f3?w=500&h=350&fit=crop" alt={t('home.occasionsBirthday')} loading="lazy" />
              <div className="occasions-home-overlay">
                <h3>{t('home.occasionsBirthday')}</h3>
              </div>
            </div>
            <div className="occasions-home-card">
              <img src="https://images.unsplash.com/photo-1558636508-e0db3814bd1d?w=500&h=350&fit=crop" alt={t('home.occasionsCorporate')} loading="lazy" />
              <div className="occasions-home-overlay">
                <h3>{t('home.occasionsCorporate')}</h3>
              </div>
            </div>
          </div>
          <div className="text-center" style={{ marginTop: 'var(--space-2xl)' }}>
            <Link to="/occasions" className="btn btn-gold btn-lg">
              {t('home.occasionsCta')}
            </Link>
          </div>
        </div>
