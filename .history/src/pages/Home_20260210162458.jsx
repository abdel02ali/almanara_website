      ...
      <section className={`hero ${isRamadan ? 'ramadan-hero' : ''}`}>
        <div className="hero-bg">
          <div className="hero-image">
            <img 
              src={isRamadan 
                ? "https://images.unsplash.com/photo-1532117182044-031e7cd916ee?w=1280&q=75&auto=format&fit=crop"
                : "https://images.unsplash.com/photo-1509440159596-0249088772ff?w=1280&q=75&auto=format&fit=crop"
              } 
