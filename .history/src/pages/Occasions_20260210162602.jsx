...
function Mariages() {
  ...
  const services = [
    { image: 'https://images.unsplash.com/photo-1535254973040-607b474cb50d?w=500&q=75&auto=format&fit=crop', titleKey: 'mariages.svcCake', descKey: 'mariages.svcCakeDesc' },
    { image: 'https://images.unsplash.com/photo-1562440499-64c9a111f713?w=500&q=75&auto=format&fit=crop', titleKey: 'mariages.svcPieceMontee', descKey: 'mariages.svcPieceMonteeDesc' },
    { image: 'https://images.unsplash.com/photo-1558636508-e0db3814bd1d?w=500&q=75&auto=format&fit=crop', titleKey: 'mariages.svcCandyBar', descKey: 'mariages.svcCandyBarDesc' },
    { image: 'https://images.unsplash.com/photo-1464349095431-e9a21285b5f3?w=500&q=75&auto=format&fit=crop', titleKey: 'mariages.svcSweetTable', descKey: 'mariages.svcSweetTableDesc' },
    { image: 'https://images.unsplash.com/photo-1578985545062-69928b1d9587?w=500&q=75&auto=format&fit=crop', titleKey: 'mariages.svcMignardises', descKey: 'mariages.svcMignardisesDesc' },
    { image: 'https://images.unsplash.com/photo-1519340241574-2cec6aef0c01?w=500&q=75&auto=format&fit=crop', titleKey: 'mariages.svcFavors', descKey: 'mariages.svcFavorsDesc' }
  ]
            ...
            {services.map((svc, i) => (
              <div key={i} className="service-card">
                <div className="service-card-image">
                  <img src={svc.image} alt={t(svc.titleKey)} loading="lazy" width="500" height="333" />
                </div>
