          ...
          <form className="checkout-form" onSubmit={handleSubmit}>
            ...
            <div className="checkout-actions">
              ...
              <button type="submit" className="btn btn-gold" disabled={orderLoading}>
                {orderLoading ? t('checkout.processing') : step === 3 ? `${t('checkout.pay')} ${finalTotal.toFixed(2)} €` : t('checkout.continue')}
              </button>
            </div>
          </form>
          ...
          <aside className="order-summary">
            ...
            <div className="summary-totals">
              ...
              <div className="summary-row">
                ...
                <span>{deliveryCost === 0 ? t('checkout.free') : `${deliveryCost.toFixed(2)} €`}</span>
              </div>
