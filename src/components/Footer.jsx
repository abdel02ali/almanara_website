...
/** Pick Arabic name when language is Arabic */
const getCatName = (cat, lang) => (lang?.substring(0, 2) === 'ar' && cat.name_ar) ? cat.name_ar : cat.name
          ...
          <div className="footer-grid">
            <div className="footer-brand">
              ...
              <div className="social-links">
                <a href="#" aria-label="Facebook" className="social-link" data-static-link="true">
                  <svg viewBox="0 0 24 24" width="20" height="20">
                    <path fill="currentColor" d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"/>
                  </svg>
                </a>
                <a href="https://www.instagram.com/almanarasweeties/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="social-link" data-static-link="true">
                  <svg viewBox="0 0 24 24" width="20" height="20">
                ...
                <a href="#" aria-label="Pinterest" className="social-link" data-static-link="true">
                  <svg viewBox="0 0 24 24" width="20" height="20">
            ...
            <div className="footer-links">
              ...
              <ul>
                {categories.map(cat => (
                  <li key={cat.id}>
                    <Link to={`/boutique/${cat.slug || cat.id}`}>{getCatName(cat, i18n.language)}</Link>
                  </li>
                ))}
              </ul>
            </div>
            ...
            <div className="footer-links">
              ...
              <ul>
                <li><Link to="/mariages">{t('nav.weddings')}</Link></li>
      ...
      <div className="footer-bottom">
        <div className="container">
          ...
          <div className="footer-legal">
            <a href="#" data-static-link="true">{t('footer.legal')}</a>
            <a href="#" data-static-link="true">{t('footer.privacy')}</a>
            <a href="#" data-static-link="true">{t('footer.terms')}</a>
          </div>
        </div>
      </div>
    </footer>
