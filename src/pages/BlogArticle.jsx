    ...
    <div className="article-page">
      <article className="article">
        ...
        <div className="article-hero">
          <img src={article.image} alt={article.title} data-static-image={article.__isStaticFallback ? 'true' : undefined} />
        </div>
                  ...
                  {latestArticles
                    ...
                    .map(a => (
                      <Link
                        ...
                        data-static-card={a.__isStaticFallback ? 'true' : undefined}
                      >
