    ...
    <div className="home">
          ...
          <div className="categories-showcase">
            {categories.slice(0, 4).map((category, index) => (
              <Link 
                ...
                style={{ '--index': index }}
                data-static-card={category.__isStaticFallback ? 'true' : undefined}
              >
      ...
      <section className="custom-section">
        <div className="custom-bg">
          <img src="https://images.unsplash.com/photo-1535254973040-607b474cb50d?w=1280&q=75&auto=format&fit=crop" alt="Wedding cake" loading="lazy" width="1280" height="600" data-static-image="true" />
        </div>
        <div className="container">
      ...
      <section className="section occasions-home-section">
        <div className="container">
          ...
          <div className="occasions-home-grid">
            <div className="occasions-home-card" data-static-card="true">
              <img src="/pictures/wed.jpeg" alt={t('home.weddingsCake')} loading="lazy" width="500" height="375" data-static-image="true" />
              <div className="occasions-home-overlay">
                <h3>{t('home.weddingsCake')}</h3>
              </div>
            </div>
            <div className="occasions-home-card" data-static-card="true">
              <img src="https://images.unsplash.com/photo-1535254973040-607b474cb50d?w=500&q=75&auto=format&fit=crop" alt={t('home.weddingsPieceMontee')} loading="lazy" width="500" height="375" data-static-image="true" />
              <div className="occasions-home-overlay">
                <h3>{t('home.weddingsPieceMontee')}</h3>
              </div>
            </div>
            <div className="occasions-home-card" data-static-card="true">
              <img src="https://images.unsplash.com/photo-1558636508-e0db3814bd1d?w=500&q=75&auto=format&fit=crop" alt={t('home.weddingsCandyBar')} loading="lazy" width="500" height="375" data-static-image="true" />
              <div className="occasions-home-overlay">
